...
public class MaleBlendShape : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        //chest = GUI.HorizontalSlider(new Rect(25, 4 * x, l, 30), chest, -100.0f, 100.0f);
        //GUI.Label(new Rect(25, 4 * x - 50, 500, 100), "Chest" + " " + (chest + 233.33f) / 6.06f + " in.");


        waist = GUI.HorizontalSlider(new Rect(25, 3 * x, l, 30), waist, -100.0f, 100.0f);
        GUI.Label(new Rect(25, 3 * x - 50, 500, 100), "Waist" + " " + (Mathf.Round((waist + 190.91f) / 6.06f * 100)) / 100.0 + " in.");
        ...
        inseam = GUI.HorizontalSlider(new Rect(25, 4 * x, l, 30), inseam, -100.0f, 100.0f);
        GUI.Label(new Rect(25, 4 * x - 50, 500, 100), "Inseam" + " " + (Mathf.Round((inseam + 358.82f) / 11.76f * 100)) / 100.0 + " in.");

        muscle = GUI.HorizontalSlider(new Rect(25, 5 * x, l, 30), muscle, -100.0f, 100.0f);
        GUI.Label(new Rect(25, 5 * x - 50, 500, 100), "Body Fat" + " ");

        toggle = GUI.Toggle(new Rect(25, 7 * x, 70, 70), toggle, "");
        GUI.Label(new Rect(25, 7 * x - 50, 500, 100), "Toggle to reset values");
    }
